...
urlpatterns = [
    ...
    path(
        "favicon.ico",
        RedirectView.as_view(url=staticfiles_storage.url("static/images/favicon.ico")),
    ),
    # team
    ## create
    ...
    path(
        "users/delete/<int:pk>/",
        views.users.MemberDeleteView.as_view(),
        name="users-delete",
    ),
    path(
        "users/edit/<int:pk>/",
        views.users.MemberUpdateView.as_view(),
        name="users-update",
    ),
    path(
        "users/edit/advanced/<int:pk>/",
        views.users.UserUpdateView.as_view(),
        name="users-update-advanced",
    ),
    path(
        "users/edit/change-password/",
        views.users.UserPasswordUpdateView.as_view(),
        name="users-update-password",
    ),
    path(
        "users/<int:pk>/", views.users.MemberDetailView.as_view(), name="users-detail"
    ),
    path(
        "users/<int:pk>/select-ctf/",
    ...
    path(
        "users/reset/",
        views.users.UserResetPassword.as_view(),
        name="user-password-reset",
    ),
    path(
        "users/reset/confirm/<str:uidb64>/<str:token>/",
        views.users.UserChangePassword.as_view(),
    ...
    path(
        "ctfs/<uuid:pk>/delete/", views.ctfs.CtfDeleteView.as_view(), name="ctfs-delete"
    ),
    path(
        "ctfs/<uuid:pk>/export-notes/",
        views.ctfs.CtfExportNotesView.as_view(),
        name="ctfs-export-notes",
    ),
    # challenges
    path(
        "challenges/",
        views.challenges.ChallengeListView.as_view(),
    ...
    path(
        "challenges/<uuid:pk>/",
        views.challenges.ChallengeDetailView.as_view(),
        name="challenges-detail",
    ),
    path(
        "challenges/<uuid:pk>/edit/",
        views.challenges.ChallengeUpdateView.as_view(),
        name="challenges-edit",
    ),
    path(
        "challenges/<uuid:pk>/delete/",
        views.challenges.ChallengeDeleteView.as_view(),
        name="challenges-delete",
    ),
    path(
        "challenges/<uuid:pk>/score/",
        views.challenges.ChallengeSetFlagView.as_view(),
        name="challenges-score",
    ),
    path(
        "challenges/<uuid:pk>/export/",
    ...
    path(
        ...
        views.files.ChallengeFileCreateView.as_view(),
        name="challenge-files-add",
    ),
    path(
        "challenges/<uuid:challenge_id>/files/<uuid:pk>/",
        views.files.ChallengeFileDetailView.as_view(),
    ...
    path(
        "categories/create/",
        views.categories.CategoryCreateView.as_view(),
    ...
    path(
        "tags/delete/<int:pk>", views.tags.TagDeleteView.as_view(), name="tags-delete"
    ),
]
...
if settings.DEBUG:
    ...
    urlpatterns += static(
        settings.CTF_CHALLENGE_FILE_URL, document_root=settings.CTF_CHALLENGE_FILE_ROOT
    )
