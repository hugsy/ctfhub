...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "api_key",
                    models.CharField(
                        default=ctfhub.helpers.get_random_string_128, max_length=128
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "team",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="ctfhub.team"
                    ),
                ),
                (
                    "user",
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        ...
                        upload_to="files/",
                        validators=[
                            ctfhub.validators.challenge_file_max_size_validator
                        ],
                    ),
                ),
        ...
        migrations.AddField(
            ...
            name="ctf",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="ctfhub.ctf"
            ),
        ),
        migrations.AddField(
            model_name="challenge",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="solved_challenges", to="ctfhub.Member"
            ),
        ),
        migrations.AddField(
            model_name="challenge",
            name="tags",
            field=models.ManyToManyField(
                blank=True, related_name="challenges", to="ctfhub.Tag"
            ),
        ),
    ]
