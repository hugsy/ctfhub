    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('selected_ctf', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='ctfpad.ctf')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='challenge',
            name='solver',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='solver', to='ctfpad.member'),
        ),
    ]
